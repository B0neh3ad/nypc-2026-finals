/* ===== jinsu_exp_d : inhyuk_v4 확장 속도 변형 (2026-08-29) ==========
   원본 inhyuk_v4.cpp 무수정. 아래 상수만 덮어쓴다(#ifndef 가드).
   근거: 거점 수가 승패를 가르고(우세 14승 0패), 진 판은 전부 거점
   열세다. POST_ATTACK 스로틀이 적 첫 공격 이후 확장을 1개로 묶는다.
   ======================================================== */
#define ENABLE_POST_ATTACK_NEUTRAL_WAIT_CONTROL 0
#define BUILD_RESERVE 260
#define OPENING_NEUTRAL_FIRST_MAX_TURN 200
#define OPENING_NEUTRAL_FIRST_MAX_TARGETS 24
#define CENTER_SECOND_BASE_MAX_SEND_PER_TURN 3
