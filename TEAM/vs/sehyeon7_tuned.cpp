/* sehyeon7_tuned : MoE 버킷2 탐색 파라미터를 sehyeon7 에 적용 (원본 무수정, #define 선언만 앞에) */
#define ANCHOR_ROUTE_MIN_ATTACKERS 42
#define ANCHOR_ROUTE_MIN_OWNED_BASES_TO_ATTACK 19
#define ANCHOR_ROUTE_START_TURN 118
#define ARMY_PARITY_MARGIN -3
#define BUILD_RESERVE 517
#define DEFENSE_HARD_ETA 45
#define DEFENSE_INBOUND_RADIUS 2
#define FINISHER_MIN_ARMY 8
#define FINISHER_START_TURN 260
#define MIN_ATTACK_WAVE_UNITS 5
#define OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN 67
#define OPENING_NEUTRAL_FIRST_MAX_TARGETS 16
#define OPENING_NEUTRAL_FIRST_MAX_TURN 163
#define OPENING_NEUTRAL_FIRST_MIN_TARGETS 10
#define OPENING_NEUTRAL_FIRST_TARGET_PERCENT 62
#define RALLY_STACK_HQ_ATTACK_START_TURN 104
#define RALLY_STACK_STAGE_START_TURN 43
#define STACK_DANGER_COUNT 3
#define STRATEGIC_HOLD_ARMY_SHARE_DEN 4
#define STRATEGIC_HOLD_STACK_RADIUS 5
#define STRATEGIC_HOLD_STACK_THRESHOLD 14
#define STRATEGIC_HOLD_START_TURN 174
#define THIN_OPENING_MAX_TURN 6
/* INHYUK V6 CANDIDATE (2026-08-29): dominant finishing plus strategic attack hold. */
...
#define OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN 40
#endif
#ifndef OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED
#define OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED 2
#endif
...
#define FORCE_HQ2_SAVE_TURN 120
#endif
