/* INHYUK V1 (2026-08-29)
   ...
   enemy warriors. */
/* Round-4 finals-log improvement: infer an early hidden mass from observed
   combat damage and preserve a minimal HQ response force for the blind rush. */
...
/* Four COMBAT damage to one healthy opening scout proves at least four enemy
   attacks at that region.  Under fog this arrives several turns before the
   seven-body HQ rush becomes visible from home, so retain a third HQ defender
   temporarily without imposing an unconditional opening-economy penalty. */
