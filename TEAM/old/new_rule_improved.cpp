/* NEW-RULE BASELINE (2026-08-29)
   ...
   Enemy warriors/buildings in GameState are the CURRENTLY VISIBLE snapshot only;
   no hidden enemy movement target/state is fabricated. */
