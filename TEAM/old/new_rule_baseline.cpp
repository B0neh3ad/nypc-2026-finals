...
/* Mechanical 200->400 day horizon adaptation.
   These are phase-position thresholds, not newly tuned strategy values.  Local
   combat horizons/lookaheads are deliberately left unchanged in this baseline. */
static void apply_new_rule_phase_turn_scaling(void) {
#ifndef HP_RATIO_TRAIN_PRIORITY_MAX_TURN
  P_HP_RATIO_TRAIN_PRIORITY_MAX_TURN *= 2;
#endif
#ifndef OPENING_NEUTRAL_FIRST_MAX_TURN
  P_OPENING_NEUTRAL_FIRST_MAX_TURN *= 2;
#endif
#ifndef OPENING_RELAX_HQ_KEEP_UNTIL_TURN
  P_OPENING_RELAX_HQ_KEEP_UNTIL_TURN *= 2;
#endif
#ifndef OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN
  P_OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN *= 2;
#endif
#ifndef OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL
  P_OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL *= 2;
#endif
#ifndef OPENING_FORCE_TRAIN_NEUTRAL_UNTIL
  P_OPENING_FORCE_TRAIN_NEUTRAL_UNTIL *= 2;
#endif
#ifndef CENTER_SPLIT_ECON_AFTER_TURN
  P_CENTER_SPLIT_ECON_AFTER_TURN *= 2;
#endif
#ifndef THIN_OPENING_MAX_TURN
  P_THIN_OPENING_MAX_TURN *= 2;
#endif
#ifndef ENDGAME_SYNC_START_TURN
...
#endif
#ifndef RALLY_STACK_STAGE_START_TURN
  P_RALLY_STACK_STAGE_START_TURN *= 2;
#endif
#ifndef RALLY_STACK_HQ_ATTACK_START_TURN
  P_RALLY_STACK_HQ_ATTACK_START_TURN *= 2;
#endif
#ifndef ANCHOR_ROUTE_START_TURN
  P_ANCHOR_ROUTE_START_TURN *= 2;
#endif
#ifndef FORCE_HQ2_SAVE_TURN
  P_FORCE_HQ2_SAVE_TURN *= 2;
#endif
#ifndef LATE_TIEBREAK_START_TURN
...
int main(void) {
  ...
  apply_new_rule_phase_turn_scaling(); /* preserve old phase positions on 400-day horizon */
